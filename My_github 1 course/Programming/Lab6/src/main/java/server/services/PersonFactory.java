...
public class PersonFactory {
     ...
     */
    public PersonFactory(IdGenerator generator, Validator validator) {
     ...
     */
    public Person create(String name, Coordinates coordinates, double height, LocalDate birthday, String passportId, Country nationality, Location location) {
